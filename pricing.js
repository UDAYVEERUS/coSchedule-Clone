document.querySelector("#opration3").addEventListener('click',chang());
function chang(){
    var text = document.querySelector('#opration3').innerText

    if( text == "Switch to Monthly"){
      
       // document.querySelector("#opration1").innerText="$39"
       // document.querySelector("#opration2").innerText="Billed Monthaly"
    }
}
